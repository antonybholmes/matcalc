 ...
 */
public class KMeansModule extends Module
implements ModernClickListener {
  ...
  public void init(MainMatCalcWindow window) {
    ...
    RibbonLargeButton button = new RibbonLargeButton("K-means",
        AssetService.getInstance().loadIcon("kmeans", 24),
