...
public class ProportionalVennCanvas extends VennCanvas {
	...
	/* (non-Javadoc)
	 * @see org.matcalc.toolbox.core.venn.VennCanvas#setGroups(org.jebtk.bioinformatics.ui.groups.GroupsModel, org.matcalc.toolbox.core.venn.CircleStyle)
	 */
	...
	public void layout() {
		...
		if (mCount == 3) {
			...
			//System.err.println("i32 " + mIntersection13 + " " + mIntersection23 + " " + mIntersection123);
			//System.err.println("i3 " + mIntersection3 + " " + CollectionUtils.iterToList(mGroups.get(2)).size());
		}
	...
	private void plotThreeCircles(Graphics2D g2) {
		...
		if (mStyle == CircleStyle.PROPORTIONAL) {
			...
			String text = Integer.toString(mGroups.get(0).size() - mIntersection12.size() - mIntersection13.size() - mIntersection123.size());
			...
			//g2.setColor(Color.BLACK);
			text = Integer.toString(mGroups.get(1).size() - mIntersection12.size() - mIntersection23.size() - mIntersection123.size());
			...
			text = Integer.toString(mGroups.get(2).size() - mIntersection13.size() - mIntersection23.size() - mIntersection123.size());
