 ...
 */
public class QuantileNormalizeModule extends CalcWinModule implements ModernClickListener {
	...
	public void init(MainMatCalcWindow window) {
		...
		RibbonLargeButton button = new RibbonLargeButton("Quantile Normalize", 
