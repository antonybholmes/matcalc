...
public class KMeansDialog extends ModernDialogHelpWindow {
  ...
  private ModernCompactSpinner mKmeansField = new ModernCompactSpinner(1, 100,
      5, 1);
  
  /**
   * The member check is log2.
   */
  private ModernTwoStateWidget mCheckZscore = new ModernCheckSwitch(
     "Z-score", true);
  ...
  private ModernTwoStateWidget mCheckSort = new ModernCheckSwitch(
      "Sort by cluster", true);
  
  private ModernTwoStateWidget mCheckRename = new ModernCheckSwitch(
      "Rename clusters");
