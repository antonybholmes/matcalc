...
public abstract class DifferentialExpressionPlotMatrixTransform extends HeatMapPlotMatrixTransform {
   ...
   */
<<<<<<< HEAD:matcalc/src/main/java/edu/columbia/rdf/matcalc/toolbox/plot/heatmap/legacy/DifferentialExpressionPlotMatrixTransform.java
...
=======
  public DifferentialExpressionPlotMatrixTransform(ModernRibbonWindow parent,
    ...
    super(parent, name, inputMatrix, groups, rowGroups, countGroups, history,
        properties);
>>>>>>> 0c6b302bf0a6d2eac18dbec9d0d2195af92c4605:edu.columbia.rdf.matcalc/src/main/java/edu/columbia/rdf/matcalc/toolbox/plot/heatmap/legacy/DifferentialExpressionPlotMatrixTransform.java
