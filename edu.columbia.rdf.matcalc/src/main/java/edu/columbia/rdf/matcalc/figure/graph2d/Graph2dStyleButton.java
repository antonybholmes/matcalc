 ...
 */
public class Graph2dStyleButton extends ModernDialogFlatDropDownIconButton {
	...
	private class ClickEvents implements ModernClickListener {
		...
		public void clicked(ModernClickEvent e) {
			...
			} else if (getText().equals("Filled Transparent")) {
				((Graph2dStyleMultiIcon16)mIcon).setIcon(1);
			} else if (getText().equals("Joined")) {
				((Graph2dStyleMultiIcon16)mIcon).setIcon(2);
			} else if (getText().equals("Lines")) {
				((Graph2dStyleMultiIcon16)mIcon).setIcon(3);
			} else if (getText().equals("Bars")) {
				((Graph2dStyleMultiIcon16)mIcon).setIcon(4);
			} else if (getText().equals("Scatter")) {
				((Graph2dStyleMultiIcon16)mIcon).setIcon(5);
			} else {
				((Graph2dStyleMultiIcon16)mIcon).setIcon(0);
			}
			*/
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.ui.button.ModernDropDownButton#drawBackground(java.awt.Graphics2D)
	 */
	/*
	@Override
