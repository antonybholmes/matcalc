...
public class CollapsePanel extends VBox {
	...
	//private ModernRadioButton mMaxStdButton = new ModernRadioButton("Max Std Dev");
	//private ModernRadioButton mMaxMeanButton = new ModernRadioButton("Max Mean");
	//private ModernRadioButton mMaxMedianButton = new ModernRadioButton("Max Median");
	...
	public CollapsePanel(DataFrame matrix, XYSeriesGroup groups) {
		...
		/*
		box2 = new VBoxPanel();
		box2.add(mNoneButton);
		box2.add(mMaxButton);
		box2.add(mMinButton);
		box2.add(mMaxStdButton);
		box2.add(mMaxMeanButton);
		box2.add(mMaxMedianButton);
		box2.setBorder(BorderService.getInstance().createLeftBorder(ModernWidget.TINY_SIZE.width));
		add(box2);
		*/
		...
		group.add(mMaxButton);
		group.add(mMinButton);
		group.add(mMaxStdButton);
		group.add(mMaxMeanButton);
