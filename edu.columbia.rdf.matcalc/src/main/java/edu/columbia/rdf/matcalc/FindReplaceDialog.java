...
public class FindReplaceDialog extends ModernDialogTaskWindow implements TabEventListener {
	 ...
	 */
	private ModernButton mFindNextButton = 
			new ModernDialogButton("Find Next");
	
	/**
	 * The member replace all button.
	 */
	private ModernButton mReplaceAllButton = 
			new ModernDialogButton("Replace All");
	
	/**
	 * The member replace button.
	 */
	private ModernButton mReplaceButton = 
			new ModernDialogButton("Replace");
	 ...
	 */
	private CheckBox mCheckFindCaseSensitive = 
			new ModernCheckBox("Case sensitive");

	/**
	 * The member check find entire cell.
	 */
	private CheckBox mCheckFindEntireCell = 
			new ModernCheckBox("Match entire cell contents");

	/**
	 * The member check replace case sensitive.
	 */
	private CheckBox mCheckReplaceCaseSensitive = 
			new ModernCheckBox("Case sensitive");

	/**
	 * The member check replace entire cell.
	 */
	private CheckBox mCheckReplaceEntireCell = 
			new ModernCheckBox("Match entire cell contents");
	...
	private void find() {
		...
		if (cell.row >= 0 && cell.column >= 0) {
			...
			mTable.setSelectedCell(cell.row,
					cell.column,
					false,
					false);
		}
